...
foreach (['background-sync.php','content-operations.php','workflow-engine.php','ai-providers.php','agent-intake.php','project-publishing.php','media-manager.php','admin-cleanup.php'] as $hcdecor_module) {
