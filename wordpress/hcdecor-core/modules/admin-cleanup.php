...
add_filter('parent_file',function($parent){
    if(isset($_GET['page']) && in_array($_GET['page'],['hcdecor-ai-workspace','hcdecor-content-operations','hcdecor-review','hcdecor-media','hcdecor-ai-providers','hcdecor-automation','hcdecor-drive-vault','hcdecor-data-backups','hcdecor-system-health','hcdecor-bridge'],true)) return 'hcdecor-hub';
    return $parent;
});
